...
* GenericValues#normal "Normal"
* GenericValues#abnormal "Klonale forandringer"
* GenericValues#not_performed "Ej udført"
* GenericValues#none "Ingen mitoser"
